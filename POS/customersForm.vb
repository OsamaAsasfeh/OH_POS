...
Public Class customersForm
    ...
    Private Sub deleteUsers()
        ...
        Try
            ...
            Dim sql As String = "DELETE FROM Customers  WHERE customer_id = @customerId"
            Dim command As New SqlCommand(sql, connection)
            command.Parameters.AddWithValue("@customerId", TextBoxID.Text)
    ...
    Private Sub AddUsers()
        Try
            ...
            Dim query As String = "INSERT INTO Customers  ( customer_name , address , email , phone_number ) VALUES (@customername, @address,@email, @phone_number)"
            ...
            cmd.Parameters.AddWithValue("@customername", TextBoxUserName.Text)
